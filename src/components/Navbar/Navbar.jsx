      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <ul className="hidden md:flex space-x-6 text-gray-300">
          {menuItems.map((item) => (
            ...
            >
              <button onClick={() => handleMenuItemClick(item.id)} className="relative group">
                {item.label}
        ...
        <div className="hidden md:flex space-x-4">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-300 hover:text-amber-400 transition duration-300 hover:scale-110"
          >
            <FaLinkedin size={20} />
          </a>
        </div>
