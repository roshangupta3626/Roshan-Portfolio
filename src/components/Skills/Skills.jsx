    ...
    <div className="relative z-10 max-w-7xl mx-auto">
      ...
      <div className="text-center mb-16">
        <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 tracking-tight">
          ...
          <span className="bg-gradient-to-r from-yellow-400 to-amber-400 bg-clip-text text-transparent">Expertise</span>
        </h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {SkillsInfo.map((category, index) => (
          <div
            key={category.title}
            className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700/50 hover:border-yellow-400/40 transition-all duration-500 hover:shadow-xl hover:shadow-yellow-500/10 hover:scale-105"
          >
