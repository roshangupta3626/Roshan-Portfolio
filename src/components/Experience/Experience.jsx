      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 tracking-tight">
            ...
            <span className="bg-gradient-to-r from-yellow-400 to-amber-500 bg-clip-text text-transparent">Experience</span>
          </h2>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {experience.skills.map((skill, skillIndex) => (
                        <span
                          key={skillIndex}
                          className="bg-gradient-to-r from-yellow-500/20 to-amber-500/20 text-yellow-300 px-3 py-1 text-sm rounded-lg border border-yellow-400/30 hover:from-yellow-500/30 hover:to-amber-500/30 transition-all duration-300"
                        >
                          {skill}
                        </span>
                      ))}
